2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0], [2, 1, 2.0]]
"""
   ...
   #解码
    ...
    def selection(self):
        ...
        for i in range(len(self.people)):
            ...
            for j in range(len(self.people[i][1])):
                for l in range(len(self.people[i][1][j][4:])):
                    count+=1
            if count!=num_vm:
                f.writelines("#选择阶段的元素不一致了")
                f.close()
                sys.exit("又来")
        return
    ...
    def crossover(self):
        ...
        for i in range(int(self.population*self.rate_cross)):
            ...
            #except:
                #print "index_mather:{}".format(index_mather)
                
            print "正式:index_mather:{}".format(index_mather)
            print "正式:index_father:{}".format(index_father)
            
            f.writelines("原mather:\n")
            f.writelines(str(mather)+'\n')            
            
            fa=copy.deepcopy(father[1])
            ma=copy.deepcopy(mather[1])
            self.corssover_once(fa,ma)
            #self.corssover_once(father[1],mather[1])
            
            """错误最先发生的地方"""
            f.writelines(str(ma)+'\n')
            f.writelines("#-----------------错误最先发生的地方--------------------------\n")
            f.writelines(str(mather)+'\n')
            ...
            try:
                ...
                print "error happend in {}".format(i)
                print "index_father:{}   index_mather".format(index_father,index_mather)
                pass
                """
            f.writelines("index_father:"+str(index_father)+"\rindex_mather"+str(index_mather)+"\n")
            for i_ in range(len(self.people)):
                count=0
                for j in range(len(self.people[i_][1])):
                    for l in range(len(self.people[i_][1][j][4:])):
                        count+=1
                if count!=num_vm:
                    f.writelines("#繁殖阶段的元素不一致了\n")
                    f.writelines("第"+str(i)+"轮\n")
                    f.writelines("第"+str(i_)+"个\n")
                    f.writelines(str(count)+'\n')
                    f.writelines(str(self.people[i_]))
                    f.writelines(str(mather))
                    f.close()
                    sys.exit("繁殖还来")
    ...
    #一次繁衍
    def corssover_once(self,father_,mather_):
        #最优随机插入算法
        f.writelines("#生育\n")
        f.writelines(str(mather_)+"\n")
        print "生育"
        father_sorted=sorted(father_)
        mather_sorted=sorted(mather_)
        
        f.writelines("排序mather\n")
        f.writelines(str(mather_sorted)+"\n")
        f.writelines("#排序father\n")
        f.writelines(str(father_sorted)+"\n")
        
        #son继承母体
        son_clone=copy.deepcopy(mather_sorted)
        
        f.writelines("mather克隆体\n")
        f.writelines(str(son_clone)+'\n')
        #对母体进行改造
        for i in range(n):
            print father_sorted
            sperm=copy.deepcopy(father_sorted[-1])
            
            
            f.writelines("#sperm\n")
            f.writelines(str(sperm)+"\n")
        
        
            egg=copy.deepcopy(son_clone[0:2])
            
            
            f.writelines("#egg\n")
            f.writelines(str(egg)+"\n")
            
            
            son=FFD_GA(sperm,egg,son_clone,True)
            """
            try:
                son=FFD_GA(sperm,egg,son,True)
            except:
                f.writelines("#出错!!!\n")
                f.writelines('sperm:'+'\r'+str(sperm)+'\n')
                f.writelines('son'+'\r'+str(son)+'\n')
                f.close()
                """
        ...
        if fit>1.0:
            f.writelines("#over fit in crossover")
            f.close()
    ...
    def mutation_once(self,son):
        ...
        if fit>1:
            print "###over fit"
            f.writelines(str(fit)+'\r'+str(spiderman)+'\n')
            sys.exit("over fit")
...
def FFD_GA(sperm,egg,mather,flag):
    print "FFD"
    num_hm_now=len(mather)
    num_now_vm=0
    
    ####
    for i in range(len(mather)):
        for j in range(len(mather[i][4:])):
            num_now_vm+=1
    f.writelines("#共有vm:\n")
    f.writelines(str(num_now_vm)+'\n')
    if num_now_vm!=num_vm:
        f.writelines("error hapend in FFD\n")
        f.writelines("#罪魁祸首\n")
        f.writelines(str(mather)+'\n')
        f.writelines("#父代基因\n")
        f.writelines(str(sperm)+'\n')
...
if __name__== '__main__':
    ...
    index=45
    for i in range(len(ecs_man.people)):
        count=0
        for i1 in range(len(ecs_man.people[index][1])):
            #count=0
            for j in range(len(ecs_man.people[index][1][i1][4:])):
                count+=1
        print count
        if count!= num_vm:
